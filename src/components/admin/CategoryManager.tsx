  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-serif text-amber-400 mb-2">Gestión de Categorías</h2>
          <p className="text-gray-400">Administra las categorías del menú</p>
        </div>
      ...
      {showAddForm && (
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-white mb-4">Agregar Nueva Categoría</h3>
          <div className="flex space-x-4">
            <input
              ...
              className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-amber-400 focus:outline-none"
              ...
              {editingCategory === category ? (
                <div className="flex-1 flex space-x-4">
                  <input
                    ...
                    className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-amber-400 focus:outline-none"
      ...
      {categories.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-sm">Agrega tu primera categoría para comenzar</p>
        </div>
      )}
    </div>
  );
