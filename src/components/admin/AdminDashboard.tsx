  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-serif text-amber-400">Panel de Administración</h1>
                <p className="text-gray-400 text-sm">Gestión del menú digital</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Navigation Tabs */}
        <div className="flex space-x-1 mb-8 bg-gray-900/30 p-1 rounded-lg w-fit">
          <button
